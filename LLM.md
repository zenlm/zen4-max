# zen4-max — AI Knowledge Base

**Project**: zen4-max
**Organization**: zenlm
**Repository**: https://github.com/zenlm/zen4-max
**HuggingFace**: https://huggingface.co/zenlm/zen4-max
**Last Updated**: 2026-02-27

## Overview

zen4-max is part of the Zen AI model family by Hanzo AI / Zen LM.
